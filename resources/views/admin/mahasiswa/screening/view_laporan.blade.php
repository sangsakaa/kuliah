  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <th class="rekap-rekap" rowspan="2">Kelompok</th>
        <th class="rekap-rekap" rowspan="2">Total</th>
        <th class="rekap-rekap" colspan="2">Status Pendaftaran</th>
      </tr>
      <tr>
    ...
    <tbody>
      @foreach ($results as $kelompok )
      <tr>
        <td class=" rekap">{{ $loop->iteration }}</td>
        <td class=" rekap">Kelompok {{ $kelompok->kelompok }}</td>
        <td class=" rekap">{{ $kelompok->total }}</td>
        <td class=" rekap">{{ $kelompok->valid_count }}</td>
        <td class=" rekap">{{ $kelompok->invalid_count }}</td>
      </tr>
      @endforeach
    </tbody>
  </table>
